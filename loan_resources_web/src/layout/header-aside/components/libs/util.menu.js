...
export function elMenuItem (createElement, menu) {
  return createElement('el-menu-item', { attrs: { style: `display: ${menu.hide === true ? 'none' : 'block'}` }, props: { index: menu.path } }, [
    ...menu.icon ? [
...
export function elSubmenu (createElement, menu) {
  return createElement('el-submenu', { attrs: { style: `display: ${menu.hide === true ? 'none' : 'block'}` }, props: { index: menu.path } }, [
    ...menu.icon ? [
